...
class OutputWriter:
    ...
    def save(
        ...
        try:
            ...
            raise ImageProcessingError(
                f"Failed to save image to {output_path}: {e}",
                original_error=e
            )
    ...
    def _generate_output_path(
        ...
        return self.validator.sanitize_output_path(
    ...
    def optimize_save(
        ...
        # Sanitize the path
        safe_path = self.validator.sanitize_output_path(
            output_path.parent,
            output_path.name
        )
        ...
        try:
            ...
            raise ImageProcessingError(
                f"Failed to save optimized image: {e}",
                original_error=e
            )